...
> Добавьте изображения в `public/` и вставьте ссылки ниже.

- `![Dashboard](public/preview-dashboard.png)`
- `![Modules](public/preview-modules.png)`
...
1) Форк и ветка под фичу.
2) Следовать существующим паттернам (TS strict, ESLint).
3) ПР с описанием изменений и скриншотами UI.

---

## 📄 Лицензия

Проект распространяется без публичной лицензии (UNLICENSED).
